...
public class StudentAttendance extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"COMPROG", "Computer Programming", "20", "18", "2", "90%", "Satisfactory"},
                {"CONARTS", "Contemporary Arts", "20", "15", "5", "75%", "Warning"},
            ...
            new String [] {
                "Course Code", "Course Name", "Total Classes", "Present", "Absent", "Attendance %", "Status"
            }
        ));
